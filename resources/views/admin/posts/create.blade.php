            ...
            <div>
                <form action="/admin/posts/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('title') }}" id="title" name="title" placeholder="Post Title" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('tags') }}" id="tags" name="tags" placeholder="Post Tags (comma separated)" required>
