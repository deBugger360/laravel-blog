<footer id="colophon" class="s-footer">
    ...
    <div class="row s-footer__subscribe">
        <div class="column lg-12">
            ...
            <form id="mc-form" class="mc-form">
                ...
                <input type="submit" name="subscribe" id="subscribe-btn" value="Subscribe" class="btn--small btn--primary u-fullwidth">
    ...
    <div class="row s-footer__main">
        ...
        <div class="column lg-5 md-6 tab-12 s-footer__about">
            ...
            <p>
            Scribe & Share is a collaborative blog where we share our written words with the world. Expect to find articles, poems, and musings on life, love, and everything in between. 
            </p>
    ...
    <div class="row s-footer__bottom">
        ...
        <div class="column lg-5 md-6 tab-12">
            <div class="ss-copyright">
                <span>&copy; Copyright Scribe & Share {{ date('Y') }}</span>
